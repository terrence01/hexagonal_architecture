...
// Service implements the CreateUserUseCase interface
type Service struct {
...
func NewService(userRepository UserRepository, emailSender EmailSender) *Service {
	return &Service{
		userRepository: userRepository,
		emailSender:    emailSender,
	}
...
func (s *Service) Execute(ctx context.Context, cmd Command) (*domain.User, error) {
